...
class AgentConfig(BaseModel):
    ...
    api_key: str = ""  # ANTHROPIC_API_KEY or OPENAI_API_KEY, optional
    base_url: str = ""  # Custom API endpoint for OpenAI-compatible providers
    ...
    def resolved_base_url(self) -> str:
        ...
        For OpenAI-compatible providers (DeepSeek, Mistral, Ollama, vLLM, etc.),
        set base_url in config to their endpoint, e.g. "http://localhost:11434/v1".
        """
        if self.base_url:
